...
$textbotlang['users']['Rules'] = "به ربات هوشمند TommyVPN خوش آمدید.💚
...
🚪 /start";
$textbotlang['users']['backorder'] = "🏠 بازگشت به اطلاعات اشتراک";
...
$textbotlang['users']['sell']['Service-select'] = "✅ لوکیشن دریافت شد اشتراکی که میخواهید خریداری کنید را انتخاب نمایید.";
$textbotlang['users']['sell']['Service-Location'] = "❌ خطا 
        📝 موقعیت اشتراک نامعتبر است";
...
$textbotlang['users']['stateus']['expired'] = "🔚 پایان زمان اشتراک";
...
$textbotlang['users']['stateus']['daysleft'] = "زمان باقی مانده اشتراک:";
$textbotlang['users']['stateus']['usedTrafficGb'] = "حجم مصرف شده اشتراک:";
$textbotlang['users']['stateus']['LastTraffic'] = "حجم کل اشتراک :";
$textbotlang['users']['stateus']['RemainingVolume'] = "حجم باقی مانده اشتراک :";
$textbotlang['users']['stateus']['info'] = "📊 اطلاعات اشتراک:";
...
$textbotlang['users']['stateus']['backlist'] = "🏠 بازگشت به لیست اشتراک ها";
$textbotlang['users']['stateus']['backservice'] = "🏠 بازگشت به مشخصات اشتراک";
$textbotlang['users']['stateus']['Invalidusername'] = "❌ نام کاربری نامعتبر است.
🔄 مجددا نام کاربری خود را ارسال کنید";
$textbotlang['users']['stateus']['manageService'] = "⚙️ تنظیمات اشتراک";
$textbotlang['users']['stateus']['DecManageService '] = "⭕️ در این بخش می توانید اشتراک خود را مدیریت کنید";
$textbotlang['users']['stateus']['config'] ="🔰 کانفیگ دستی";
$textbotlang['users']['stateus']['notconnected'] ="متصل نشده";


$textbotlang['users']['extend']['title'] ="📌 تمدید اشتراک";
$textbotlang['users']['extend']['confirm'] = "تایید تمدید";
$textbotlang['users']['extend']['thanks'] = "با تشکر از تمدید اشتراک خود🙏

⭕️تمدید شما با موفقیت انجام شد با تشکر از پرداخت شما
 
⬅️ برای بازگشت به لیست اشتراک های خود یا مشاهده اطلاعات روی دکمه های زیر کلیک کنید";
...
$textbotlang['users']['Extra_volume']['extraadded'] = "✅ حجم با موفقیت به اشتراک شما اضافه گردید.";
...
$textbotlang['users']['help']['btninlinebuy'] = "🔹♦️ آموزش استفاده ♦️🔹";
...
$textbotlang['users']['support']['btnsupport'] = "🔶 در دکمه زیر ( سوالات متداول ) سوالات و مشکلات پرتکرار کاربران توضیح داده شده است. ابتدا به این بخش مراجعه کنید درصورت نیافتن پاسخ خود به پشتیبانی پیام دهید.";


$textbotlang['users']['Balance']['priceinput'] = "✨مقدار شارژ مورد نظر را به تومان وارد کنید (بیشتر از 10.000 تومان)";
...
$textbotlang['users']['changelink']['warnchange'] = "⚠️ در صورت بروزرسانی لینک اشتراک کانفیگ ها اشتراک شما قطع شده و باید از بخش تنظیمات اشتراک کانفیگ یا لینک اشتراک جدید را دریافت کنید.";
$textbotlang['users']['changelink']['confirm'] = "تغییر لینک اتصال";
$textbotlang['users']['changelink']['confirmed'] = "✅ لینک اتصال شما بروزرسانی و کانفیگ قبلی قطع گردید برای دریافت کانفیگ جدید منوی تنظمیات اشتراک مراجعه کرده و کانفیگ جدید را تهیه کنید.";
...
$textbotlang['users']['stateus']['descriptions_removeservice'] = " با کلیک بر روی دکمه \"✅ درخواست حذف اشتراک را دارم\"، درخواست حذف اشتراک شما به مدیریت ارسال خواهد شد و پس از بررسی، اشتراک شما کنسل خواهد شد.\n\n❌ در صورت تأیید مدیریت، مبلغ مصرفی باقی‌مانده به کیف پول شما واریز خواهد شد.\n\nمتشکریم که از خدمات ما استفاده می‌کنید.";
...
$textbotlang['users']['stateus']['sendrequestsremove'] ="📌 با کلیک بر روی دکمه \"✅ درخواست حذف اشتراک را دارم\"، درخواست حذف اشتراک شما به مدیریت ارسال خواهد شد و پس از بررسی، اشتراک شما کنسل خواهد شد.\n\n❌ در صورت تأیید مدیریت، مبلغ مصرفی باقی‌مانده به کیف پول شما واریز خواهد شد.\n\nمتشکریم که از خدمات ما استفاده می‌کنید.";
...
$textbotlang['users']['Volume-Service'] = "🌐 حجم اشتراک";
...
$textbotlang['users']['Service']['Location'] = "🌏 موقعیت اشتراک خود را انتخاب نمایید.";
...
$textbotlang['Admin']['ManageUser']['RemoveService'] = "در این بخش می توانید  اشتراکی  داخل ربات حذف نمایید.
برای حذف اشتراک نام کاربری که داخل پنل ثبت شده بود را ارسال نمایید";
$textbotlang['Admin']['ManageUser']['RemovedService'] = "✅ اشتراک کاربر حذف گردید.";
...
$textbotlang['Admin']['Status']['onhold'] = "وضعیت قابلیت اولین اتصال اشتراک";
...
در صورت فعال بودن این قابلیت  در قسمت مدیریت اشتراک ها یک  دکمه اضافه میشود که  کاربر از طریق اون میتواند نام کاربری را ارسال   و اطلاعات اکانت  را مشاهده کند.";
...
$textbotlang['Admin']['Usertest']['TimeUpdated'] = "✅ زمان اشتراک تست بروزرسانی شد";
$textbotlang['Admin']['Usertest']['VolumeUpdated'] = "✅ حجم اشتراک تست بروزرسانی شد";
